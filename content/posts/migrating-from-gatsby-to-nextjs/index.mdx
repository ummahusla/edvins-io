...
Using `readFile` to load the local font is more reliable than fetching from external URLs and avoids potential format compatibility issues with ImageResponse.
...
- Uses the same font as the website for brand consistency
