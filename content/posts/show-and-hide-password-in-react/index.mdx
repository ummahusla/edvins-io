...
description: In this article, you’ll learn how to show and hide password input field in React.js using basic state manipulations. Moreover, you will learn how to make this component more re-usable to suit your needs.
date: 2018-12-18
tags:
  - React
banner: ./intro.png
...
- [Demo on CodeSandbox](https://codesandbox.io/s/zk11w6v21p)
- [Source code](https://github.com/edvins-io/snippets/blob/master/react/PasswordShowHide.md)
