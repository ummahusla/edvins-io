...
In React, there is three basic techniques that you can use to split your code into smaller chunks and load them on demand.
...
Now when we know some basics, let's use them to create more advanced techniques.
